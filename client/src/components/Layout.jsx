...
/**
 * Header control for the colour scheme. It shows the mode that is currently
 * in force and cycles system -> light -> dark on click; the label spells the
 * next step out because an icon alone cannot say "follow my OS".
 */
const THEME_LABELS = {
